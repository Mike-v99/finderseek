...
function tplNewHuntInCity({ username, city, prize, huntUrl }) {
  return {
    ...
    html: html('New Quest', `
      <h1>New Quest in ${city}! 🗺️</h1>
      <p>Hey ${username}, a new treasure quest just went live in your city.</p>
      <div class="highlight">
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Email city seekers: new quest in your city
    ...
    // Also notify seekers who were following the quest
    if (event === 'hunt_expired') {
      ...
      // Email seekers who followed this quest
